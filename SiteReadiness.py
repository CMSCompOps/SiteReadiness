...
parser.add_option("-i", "--input",   metavar="PATH",    default="input/", help="input file path")
parser.add_option("-c", "--css",     metavar="PATH",    default="css/",   help="css file path")
...
cinfo = ColumnInfo(options) # read input files
